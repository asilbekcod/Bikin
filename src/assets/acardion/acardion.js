export const Acar=[
    ...
    {
        bg:"#fff",
        name:"Feugiat scelerisque varius morbi enim nunc faucibus a pellentesque? ",
    ...
    {
        bg:"#fff",
        name:"Dolor sit amet consectetur adipiscing elit pellentesque habitant morbi? ",
    ...
    {
        bg:"#fff",
        name:"Ac odio tempor orci dapibus. Aliquam eleifend mi in nulla? ",
        text:"Dolor sit amet consectetur adipiscing elit pellentesque habitant morbi. Id interdum velit laoreet id donec ultrices. Fringilla phasellus faucibus scelerisque eleifend donec pretium. Est pellentesque elit ullamcorper dignissim. Mauris ultrices eros in cursus turpis massa tincidunt dui"
    },
    {
        bg:"#fff",
        name:"Tempus quam pellentesque nec nam aliquam sem et tortor consequat? ",
    ...
    {
        bg:"#fff",
        name:"Tortor vitae purus faucibus ornare. Varius vel pharetra vel turpis nunc eget lorem dolor? ",
